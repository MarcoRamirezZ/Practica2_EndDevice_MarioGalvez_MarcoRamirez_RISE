...
#define ZPS_NODE_ROUTER

#define ZPS_NODE_COORDINATOR
...
#define ZPS_APS_AIB_INIT_SECURITY_TIMEOUT_PERIOD         0x1770 
/*****************************************************************************/
...
#define AF_SIMPLE_DESCRIPTOR_TABLE_SIZE    3/*2 Added 3th for termperature measurement*/
...
#define ZPS_PRECONFIGURED_TRUST_CENTER_LINK_KEY FALSE
/*****************************************************************************/
...
#define ZPS_ROUTE_DISCOVERY_TABLE_SIZE 4

/* MAC address table size */
#define ZPS_MAC_ADDRESS_TABLE_SIZE    36

/*! Binding table Size */
#define ZPS_BINDING_TABLE_SIZE        4
